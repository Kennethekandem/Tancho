					...
					<div class="posts">
						<div class="posts-inner">
							<article class="post">
								...
								<div class="post-media">
									<img src="{{ asset('assets/images/single.jpg') }}" alt="Post">
								</div>
						...
						<div id="related-posts">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="post">
										<div class="post-media" style="background-image: url({{ asset('assets/images/posts/4.jpg') }})">
											<a href="single.html">
												<img src="{{ asset('assets/images/posts/4.jpg') }}" alt="Image">
											</a>
										</div>
								...
								<div class="col-sm-6">
									<div class="post">
										<div class="post-media" style="background-image: url({{ asset('assets/images/posts/2.jpg') }})">
											<a href="single.html">
												<img src="{{ asset('assets/images/posts/2.jpg') }}" alt="Image">
											</a>
										</div>
										<div class="post-entry">
											<h3 class="title">
										...
										<div class="comment-body">
											<div class="comment-head">
												<div class="comment-avatar">
													<img alt="avatar" src="{{ asset('assets/images/avatar-150px.jpg') }}">
												</div>
